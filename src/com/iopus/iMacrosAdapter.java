...
public class iMacrosAdapter {
	...
	public String iimInit() {
		try {
			...
			return "COMException：" + e.getMessage();
		}
		return err_msg;
	}
	 ...
	 * 
	 */
	public String iimInit(String command) {
		try {
			imacros = new IMacrosWrapper();
	 ...
	 * @return 执行返回信息：success成功其他返回错误信息
	 */
	public String iimInit(String command, boolean startBrowser) {
		try {
			imacros = new IMacrosWrapper();
	 ...
	 * @return 执行返回信息：success成功其他返回错误信息
	 */
	public String iimSet(String variable, String value) {
		try {
	 ...
	 * @return 执行返回信息：success成功其他返回错误信息
	 */
	public String iimFileSet(String path) {
	 ...
	 * @return 执行返回信息：success成功其他返回错误信息
	 */
	public String iimFileSet(String path, String separator) {
	 ...
	 * @return 执行返回信息：success成功其他返回错误信息
	 */
	public String iimDisPlay(String text) {
		try {
	 ...
	 * @return 执行返回信息：success成功其他返回错误信息
	 */
	public String iimDisPlay(String text, int timeout) {
		try {
	...
	public String iimPlay(String iimScriptName) {
		try {
	...
	public String iimPlay(String iimScriptName, int timeout) {
		try {
	...
	public String iimCodePlay(String code) {
		try {
	...
	public String iimCodePlay(String code, int timeout) {
		try {
	...
	public String iimGetLastExtract() {
		try {
	 ...
	 * @return 返回信息内容
	 */
	public String iimGetLastExtract(int index) {
		try {
	 ...
	 * @return 执行返回信息：success成功其他返回错误信息
	 */
	public String iimExit(int timeout) {
		try {
	 ...
	 */
	public String iimGetInterfaceVersion() {
		try {
	 ...
	 * @return 执行返回信息：success成功其他返回错误信息
	 */
	public String iimTakeBrowserScreenshot(String FILEPATH, int Code) {
		try {
